        ...
        if (err) {
            switch (err) {
                case errorCodes.MODULE_INSTALL:
                    ...
                    console.log("  * Reinstall paper-press by global, ".gray + "npm install -g paper-press".bold);
                    console.log("  * Read more guide on ".gray + "https://github.com/seokju-na/paper-press.git".underline.gray);
                    break;

                case errorCodes.SURGE_LOGIN:
                    console.log("[ERROR] ".red + "Not currently authenticated on surge.".red);
                    console.log("  * Login on surge. Please login surge - ".gray + "surge login".bold);
                    console.log("  * Did you install surge by global? ".gray + "npm install -g surge".bold);
                    console.log("  * Read more guide on ".gray + "https://github.com/seokju-na/paper-press.git".underline.gray);
                    break;
